            ...
            <div class="page-header-content">
                <div class="row align-items-center justify-content-between pt-3">
                    ...
                    <div class="col-12 col-xl-auto mb-3">
                        <a class="btn btn-sm btn-light text-primary" href="{{ route('categorys.create') }}">
            ...
            <div class="card-body p-0">
                ...
                <div class="table-responsive table-billing-history">
                    <table class="table mb-0">
                        ...
                        <tbody>
                            @foreach ($donnees as $categorys)
                                <tr>
                                    <td>{{ $categorys->id }}</td>
                                    <td>{{ $categorys->nom }}</td>
                                    <td>
                                        <form action="{{ route('categorys.destroy', $categorys->id) }}" method="post">
                                            <a class="btn btn-datatable btn-icon btn-transparent-dark" href="{{ route('categorys.edit', $categorys->id) }}">
