            ...
            <div class="page-header-content">
                <div class="row align-items-center justify-content-between pt-3">
                    ...
                    <div class="col-12 col-xl-auto mb-3">
                        <a class="btn btn-sm btn-light text-primary" href="{{ route('home.create') }}">
                    ...
                    <table class="table mb-0">
                        <thead>
                            <tr>
                                ...
                                <th class="border-gray-200" scope="col">City</th>
                                <th class="border-gray-200" scope="col">Address</th>
                                <th class="border-gray-200" scope="col">Num-Tel</th>
                                <th class="border-gray-200" scope="col">Price</th>
                                <th class="border-gray-200" scope="col">Nb-Place</th>
                                <th class="border-gray-200" scope="col">Nb-Bath</th>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <form action="{{ route('home.destroy', $home->id) }}" method="post">
                                            <a class="btn btn-datatable btn-icon btn-transparent-dark" href="{{ route('home.edit', $home->id) }}">
                                            ...
                                            <button class="btn btn-datatable btn-icon btn-transparent-dark"  type="submit" >
                                                ...
                                                <a class="btn btn-primary btn-xs me-2 my-1" href="{{ route('indexe.image', $home->id) }}">images</a>
